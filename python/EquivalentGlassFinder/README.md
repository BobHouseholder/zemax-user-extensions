...
Find nd/Vd/dPgF glass equivalents; optional apply/reopt.
...
"%PY%" python\EquivalentGlassFinder\equivalent_glass_finder.py ^
...
```bat
python equivalent_glass_finder.py -file C:\path\to\sample.zmx
```

### Flags

`-file <zmx> -catalog NAME -includeobsolete -report -reopt -save -top N -wnd -wvd -wpgf -out -quiet`
