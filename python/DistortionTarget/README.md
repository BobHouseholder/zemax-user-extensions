...
"%PY%" python\DistortionTarget\distortion_target.py ^
...
```bat
python distortion_target.py -file C:\path\to\sample.zmx
```

### Flags

`-n -pitch -dot -plate -thick -material -coating -film -drawlimit -rig -save -file -nodialog -quiet`
