# LayoutRender (Python / ZOS-API)

Public **Python** port of the C# OpticStudio user extension
[`extensions/LayoutRender`](../../extensions/LayoutRender/).
Y-Z sequential layout PNG without a layout window.
...
"%PY%" python\LayoutRender\layout_render.py ^
...
```bat
python layout_render.py -file C:\path\to\sample.zmx
```

### Flags

`-file <zmx> -out <png> -rays N -width W -height H -noorient -quiet`
