# CryoGlass (Python / ZOS-API)

Public **Python** port of the C# OpticStudio user extension
[`extensions/CryoGlass`](../../extensions/CryoGlass/).
NASA CHARMS cryogenic n(λ,T) frozen into .AGF at T0.
...
"%PY%" python\CryoGlass\cryo_glass.py ^
...
```bat
python cryo_glass.py -file C:\path\to\sample.zmx
```

### Flags

`-temp T -range T1:T2:N -materials SI,GE -fitbox K -out <agf> -file <zmx> -selftest -quiet`
