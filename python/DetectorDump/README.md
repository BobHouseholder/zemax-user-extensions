# DetectorDump (Python / ZOS-API)

Public **Python** port of the C# OpticStudio user extension
[`extensions/DetectorDump`](../../extensions/DetectorDump/).
Exports every NSC detector: native/CSV/PNG + summary.
...
"%PY%" python\DetectorDump\detector_dump.py ^
...
```bat
python detector_dump.py -file C:\path\to\sample.zmx
```

### Flags

`-file <zmx> -dir <folder> -trace -data N -log -nocsv -nopng -nonative -quiet`
